        ...
        <nav className="border-b border-slate-900 bg-slate-950/80 backdrop-blur-md sticky top-0 z-50">
          <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div className="flex gap-6 items-center">
              <Link to="/" className="text-sm font-semibold text-slate-300 hover:text-white transition">Catálogo</Link>
              <Link to="/conta" className="text-sm font-semibold text-slate-300 hover:text-white transition">Minha Conta</Link>
              <div className="w-8 h-8 rounded-lg bg-blue-600 flex items-center justify-center text-xs font-black text-white shadow-md">R</div>
            </div>
          </div>
        </nav>
